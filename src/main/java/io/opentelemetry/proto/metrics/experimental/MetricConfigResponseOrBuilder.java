...
public interface MetricConfigResponseOrBuilder extends
   ...
   */
  java.util.List<io.opentelemetry.proto.metrics.experimental.MetricConfigResponse.Schedule> 
      getSchedulesList();
  /**
   * <pre>
   * A single metric may match multiple schedules. In such cases, the schedule
   ...
   * <code>repeated .opentelemetry.proto.metrics.experimental.MetricConfigResponse.Schedule schedules = 2;</code>
   */
  io.opentelemetry.proto.metrics.experimental.MetricConfigResponse.Schedule getSchedules(int index);
  /**
   * <pre>
   * A single metric may match multiple schedules. In such cases, the schedule
   * that specifies the smallest period is applied.
   ...
   * <code>repeated .opentelemetry.proto.metrics.experimental.MetricConfigResponse.Schedule schedules = 2;</code>
   */
  java.util.List<? extends io.opentelemetry.proto.metrics.experimental.MetricConfigResponse.ScheduleOrBuilder> 
   ...
   * <code>repeated .opentelemetry.proto.metrics.experimental.MetricConfigResponse.Schedule schedules = 2;</code>
   */
  io.opentelemetry.proto.metrics.experimental.MetricConfigResponse.ScheduleOrBuilder getSchedulesOrBuilder(
      int index);
