...
@java.lang.Deprecated public interface IntHistogramDataPointOrBuilder extends
   ...
   */
  java.util.List<io.opentelemetry.proto.metrics.v1.IntExemplar> 
      getExemplarsList();
  /**
   * <pre>
   * (Optional) List of exemplars collected from
   ...
   * <code>repeated .opentelemetry.proto.metrics.v1.IntExemplar exemplars = 8;</code>
   */
  io.opentelemetry.proto.metrics.v1.IntExemplar getExemplars(int index);
  /**
   * <pre>
   * (Optional) List of exemplars collected from
   * measurements that were used to form the data point
   ...
   * <code>repeated .opentelemetry.proto.metrics.v1.IntExemplar exemplars = 8;</code>
   */
  java.util.List<? extends io.opentelemetry.proto.metrics.v1.IntExemplarOrBuilder> 
   ...
   * <code>repeated .opentelemetry.proto.metrics.v1.IntExemplar exemplars = 8;</code>
   */
  io.opentelemetry.proto.metrics.v1.IntExemplarOrBuilder getExemplarsOrBuilder(
      int index);
}
